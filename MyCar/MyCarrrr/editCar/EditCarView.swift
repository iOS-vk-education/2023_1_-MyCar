...
class EditCarView: UIView {
    ...
    private func setupContentField() {
        ...
        configureTextField(carBrandTextField, placeholder: "Enter car brand", content: car.brand)
        
        let carModelTextField = UITextField()
        // Настройка текстового поля для модели
        configureTextField(carModelTextField, placeholder: "Enter car model", content: car.model)

        let carYearTextField = UITextField()
        // Настройка текстового поля для цвета
        configureTextField(carYearTextField, placeholder: "Enter car year", content: String(car.year))

        let carMileageTextField = UITextField()
        // Настройка текстового поля для пробега
        configureTextField(carMileageTextField, placeholder: "Enter car mileage", content: String(car.mileage))

        let carColorTextField = UITextField()
        // Настройка текстового поля для цвета
        configureTextField(carColorTextField, placeholder: "Enter car color", content: car.color)

        let vinNumberTextField = UITextField()
        // Настройка текстового поля для ВИН номера
        configureTextField(vinNumberTextField, placeholder: "Enter VIN number", content: String(car.vinNumber))
    ...
    private func configureTextField(_ textField: UITextField, placeholder: String, content: String?) {
    ...
    //TODO: сделать чтобы по updateB обновлялась модель car!
